...
import { signupCliente } from "../api";

export default function ClienteSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setCargando(true);
    try {
      await signupCliente(email, password, confirmar, nombre, telefono);
      setExito(true);
    } catch (err) {
      ...
      <div className="login-screen">
        <div className="login-box">
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <button className="btn-primary" onClick={() => navigate("/portal/login")}>
              Ir al login
            </button>
          </div>
        </div>
  ...
  return (
    <div className="login-screen">
      <div className="login-box">
        ...
        <p className="subtitulo">Crear cuenta de cliente</p>
